...
def procesar(segmentos, reqs, marcos_libres):
    tam_pagina = 0x10  # Tamaño de página
    tabla_paginas = {}  # Mapea número de página -> marco asignado
    uso_lru = []        # Lista con el orden de uso LRU
    resultados = []

    for req in reqs:
        # Validar si req está dentro de un segmento válido
